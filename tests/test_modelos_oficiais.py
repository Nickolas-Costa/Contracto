...
class TestCamposBatemComOMapeamento(unittest.TestCase):
    """Confere que TODOS os campos usados em generator_service.py realmente
    ...
    def test_campos_do_ppe(self):
        ...
        campos_esperados = {
            generator_service.CAMPO_PPE_NOME,
            generator_service.CAMPO_PPE_CPF,
            generator_service.CAMPO_PPE_DIA,
            generator_service.CAMPO_PPE_MES,
            generator_service.CAMPO_PPE_ANO,
            generator_service.CAMPO_PPE_LOCAL,
        }
    ...
    def test_campos_do_primeiro_imovel(self):
        ...
        campos_esperados = {
            generator_service.CAMPO_PRIMEIRO_IMOVEL_NOME,
            generator_service.CAMPO_PRIMEIRO_IMOVEL_CPF,
            generator_service.CAMPO_PRIMEIRO_IMOVEL_ENDERECO,
            generator_service.CAMPO_PRIMEIRO_IMOVEL_DATA,
            generator_service.CAMPO_PRIMEIRO_IMOVEL_LOCAL,
        }
        ausentes = campos_esperados - campos_no_pdf
        self.assertEqual(
            ausentes,
...
class TestGeracaoPontaAPontaComPdfsReais(unittest.TestCase):
    ...
    def test_gera_e_preenche_corretamente_com_os_pdfs_reais(self):
        ...
        caminho_imovel = self.pasta_saida / "PRIMEIRO IMOVEL - JOSE.pdf"
